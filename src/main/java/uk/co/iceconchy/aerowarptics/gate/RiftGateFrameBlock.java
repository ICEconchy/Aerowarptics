 ...
 * wall, and a wall of forty blocks does not need forty machines in it. Everything a gate knows lives on
 * its controller, which finds the frame by looking rather than by being told.
 *
